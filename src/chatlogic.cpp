...
ChatBot onstackBot = ChatBot("../images/chatbot.png");

  onstackBot.SetRootNode(rootNode);
  onstackBot.SetChatLogicHandle(this);

  rootNode->MoveChatbotHere(std::move(onstackBot));
    ////
    //// EOF STUDENT CODE
}
