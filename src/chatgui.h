...
#include <wx/wx.h>
#include<memory>   // Task1 - incude this for smart pointer
...
private:
    ...
    // ChatLogic *_chatLogic; //Task 1 -remove this and convert pointer to unique for exclusive ownership
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); }  //task1 - use .get() to return smart pointer
